<section class="sectionRsvp" id="rsvp">
    <div class="sectionRsvp__wrapper">
        <div class="sectionRsvp__content">
            ...
            <p class="font--bosque heading--14 color--333" style="-webkit-text-stroke-width: inherit;">Por favor conﬁrmar asistencia antes 1 de NOVIEMBRE del 2024</p>
            <div class="space space--10"></div>
            <p class="font--bosque heading--14 color--333" style="-webkit-text-stroke-width: inherit;">Kindly respond by NOVEMBER 1th, 2024</p>
