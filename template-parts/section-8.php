...
<section class="sectionCartagena">
	...
	<div class="">
		<div class="sectionCartagena__title">
			<h2 class="heading--64 color--D6B77A">CARTAGENA</h2>
			<p class="font--bonvivant heading--48 color--222">places to visit</p>
			...
			<p class="font--bosque heading--18 color--000">
				...
				<br>
				La mejor forma de conocer Cartagena es paseando por ella, sumergiéndose en el laberinto de callejuelas y exuberantes plazas verdes. Recomendamos alojarse en la ciudad amurallada, donde todo está a un paso. Las calles están llenas de música en directo, espléndidos restaurantes y extravagantes bares, que contribuyen a la vibrante atmósfera de Cartagena.</p>
		</div>
		<div class="sectionCartagena__places">
			<?php foreach ($places as $category) { ?>
					<div class="space space--70"></div>
					<h2 class="heading--36 color--4E6585" id="<?php echo $category['id']; ?>">
						...
						<?php foreach ($category['places'] as $place) { ?>
							<div class="sectionCartagena__card">
									<div class="sectionCartagena__padding">
											...
											<h2 class="heading--24 color--4E6585">
													<?php echo $place['name']; ?>
											</h2>
	
											<?php if ($place['address']) : ?>
											<p class="font--bosque heading--18 color--4D4D4D"><?php echo $place['address']; ?></p>
											<?php endif?>
	
											<?php if ($place['city']) : ?>
											<p class="font--bosque heading--18 color--4D4D4D"><?php echo $place['city']; ?></p>
											<?php endif?>

											<div class="space space--20"></div>
	
											<?php if ($place['phone']) : ?>
											<p class="font--bosque heading--24 color--4D4D4D" style="-webkit-text-stroke-width: inherit;letter-spacing: 0.96px;"><?php echo $place['phone']; ?></p>
											<?php endif?>
